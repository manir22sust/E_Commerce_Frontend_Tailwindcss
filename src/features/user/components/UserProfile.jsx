      ...
      <div className="mx-auto mt-12 max-w-7xl bg-white px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <button
            ...
            type="submit"
            className="my-5 rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Add Address
          </button>
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                      <button
                        ...
                        type="submit"
                        className="text-grey rounded-md px-3 py-2 text-sm font-semibold shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Cancel
                      </button>
                      <button
